...
For accessing this data, a number of methods are available on :ref:`OpenXRFbHandTrackingCapsulesExtension <class_openxrfbhandtrackingcapsulesextensionwrapper>`.
